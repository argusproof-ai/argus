...
For auditors and compliance teams. Every result below is **signed and
independently verifiable** — no trust required.

## 0. Install (30 seconds)

```bash
git clone https://github.com/argusproof-ai/argus && cd argus
...
python probe_model.py    --model claude-opus-4-8   # disparate treatment (correspondence test)
